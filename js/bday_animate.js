...
$( window ).load(function() {
  ...
  var minYDistance = (function() {
    ...
    // console.log('underlayHeight = ' + underlayHeight );
  ...
  // console.log("min vertical distance for balloons to float = " + minYDistance);
  //================================================
  ...
  var cakeContainerSequence = [
    ...
    { elements: cakeObj , properties: "reverse", options: { duration: 1500, sequenceQueue: false } },                        //* CSS */             
    { elements: flames , properties: { translateX: [ 0.8 , 0 ], translateY: [ 4.8 , 0 ] , scale: [ 0.8 , 1 ] }, options: { duration: 1000, loop: true } },
    // { elements: bannerObj, properties: { translateY: [ "0px" , -minYDistance ] }, options: { duration: 2000, sequenceQueue: false } },   
  ...
  var blowOutSequence = [
    ...
    { elements: balloonsObj, properties: { translateY: ["0px", minYDistance ] }, options: { duration: 5000, sequenceQueue: false } },
  ...
  function initialAnimation(event) {
    ...
    if (event.target.id === 'continue' || 'close') {        //when #continue or #close are clicked
      ...
      $(bannerObj).velocity( { translateY: [ -minYDistance , "0px" ] } ); //move out of view.  animated back to place in cakeContainerSequence
      $(balloonsObj).velocity( {translateY: [ minYDistance , "0px" ] } ); //move out of view.  animated back to place in blowOutSequence
